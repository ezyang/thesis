...
% So, the point here is we don't bother trying to solve
% cross-eyed double vision (which requires an import realizer
% to let us know that U = Int), because our mixin operation is
% NOT ORDERED so there isn't any well-defined way to do the
% realizer.  We suggest, if the programmer wants to
